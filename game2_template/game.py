...
def print_menu(exits, room_items, inv_items):
    ...
    for single_inv_item in inv_items:
        print("DROP",single_inv_item["id"].upper(),"to drop your",single_inv_item["name"]+".")    
...
def execute_go(direction):
    ...
    """if direction == is_valid_exit(exits, chosen_exit):
...
def execute_take(item_id):
    ...
    for item in current_room["items"]:
        if item_id == item["id"]: 
            ...
            if weight >= 70:
                print("you cannot carry anymore things")
            else:
...
def execute_drop(item_id):
    ...
    weight = 0
    i = 0 
    for single_inv_item in inventory:
        if item_id == single_inv_item["id"]:
...
"""def calc_weight(weight):
    if weight < 100 and:
        ...
        print("your carrying as much as you can")
    return weight"""
